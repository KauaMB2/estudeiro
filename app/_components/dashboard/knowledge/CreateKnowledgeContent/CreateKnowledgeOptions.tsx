    ...
    <>
      <div className="flex flex-row justify-between w-full mt-5">
        <div className="flex flex-row justify-between w-full mb-4">
          ...
          >
            <Image src={FileIcon} width={56} height={56} className="pr-4" alt="personality" />
          ...
          >
            <Image src={WebsiteIcon} width={56} height={56} className="pr-4" alt="knowledge" />
          ...
          >
            <Image src={YoutubeIcon} width={56} height={56} className="pr-4" alt="skills" />
          ...
          >
            <Image src={FAQIcon} width={56} height={56} className="pr-4" alt="training" />
